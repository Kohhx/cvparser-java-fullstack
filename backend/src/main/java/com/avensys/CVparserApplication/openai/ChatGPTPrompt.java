...
public class ChatGPTPrompt {
    ...
    public final static String GPTPROMPT3 =
            """
                    ...
                    //                                                     primarySkills (array): The skills possessed by the candidate, frequently appearing throughout the resume. Just technical skills and software skills, no linguistic languages. If empty, return skills array.\s
                    //                                                     secondarySkills (array): The skills possessed by the candidate, but doesn't show up in the primary skills. Return some skills.\s
                                                                         primarySkills (array): From skills array, select the primary skills frequently appearing throughout the resume. Just technical skills and software skills, no linguistic languages. If empty, return skills array.\s
                                                                         secondarySkills (array):  From skills array, select the secondary skills that doesn't show up in the primary skills.\s
                                                                         ...
                                                                         companiesDetails (array): return every companies the candidate worked with including internships. Sort the array from the most recent to least recent in terms of endDate.\s
    ...
    public final static String GPTPROMPT3_18072023 =
            """
                      Please help me extract the following fields from each CV and use the followings as the keys:\s
                                                     name (string): The name of the candidate. Letter of each word is capital, the rest are lowercase.\s
                                                     firstName (string): The first name of the candidate. Letter of each word is capital, the rest are lowercase.\s

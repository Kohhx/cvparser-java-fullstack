    ...
    public final static String GPTPROMPT3 =
            """
                      Please help me extract the following fields from each CV and use the followings as the keys:\s
                                                     ...
                                                     primarySkills (array): The skills possessed by the candidate, frequently appearing throughout the resume. Skills candidate is good at. Just technical skills and software skills, no linguistic languages. Cannot return empty.\s
                                                     secondarySkills (array): The skills possessed by the candidate, but doesn't show up in the primary skills. Cannot return empty.\s

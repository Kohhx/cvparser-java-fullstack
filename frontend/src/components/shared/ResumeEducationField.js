...
const ResumeEducationField = ({education, index, educationDetailsChange}) => {
  ...
  useEffect(() => {
    console.log("Change ED Details", educationDetail)
      ...
      <p className="d-flex gap-1 align-items-center">
        ...
        {editable && (
          <button
            ...
            onClick={() =>
              computeNoOfYears(educationDetail.startDate, educationDetail.endDate)
            }
          >
            Compute
          </button>
